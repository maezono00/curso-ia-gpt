...
def get_moedas():
    ...
    try:
        ...
        return f"{dolar:.2f} USD = 1 BRL | {euro:.2f} EUR = 1 BRL. Essas informações foram obtidas em: {data_convertida}"
    except:
        return "Cotação não realizada, tente novamente."

personalidade = st.sidebar.selectbox("Personalidade", ["Professor de Python", "Professor de História", "Cientista maluco", "Conversor de moedas"])
...
descricao = {
    ...
    "Conversor de moedas" : "Você é um especialista em conversão de moedas que responde de forma simples e clara, sempre informando o valor da moeda especificada."
}
